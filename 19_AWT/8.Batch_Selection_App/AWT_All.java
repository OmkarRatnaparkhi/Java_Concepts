import java.awt.*;					//importing all components from awt
...
public class AWT_All
{
    ...
    public AWT_All()
    {
        mainFrame = new Frame("Marvellous Infosystems");		//Object creation of Frame Class and passing string to that object so that our Frame will contain that name which is at top.
    ...
    {
        AWT_All  obj = new AWT_All();				//Our frame will get created 
        obj.Display();								//Buttons and events to that buttons will get added on frame.
    }
    ...
    private void Display()
    {
        ...
        Button PPA = new Button("PPA");					//Object creation of Button Class and passing string to that object so that our button will contain that name.
